...
function game() {
  ...
  else if ( (user2===obj[0] && (bot===1)) || (user2===obj[1] && (bot===2)) || (user2===obj[2] && (bot===0)) ) {
      document.getElementById("result2").innerHTML = `You: ${user2} <br />Bot: ${obj[bot]} <br />Hurray! I defeated you. <br /><br />`;
  }

  else {
      alert("Invalid Input");
    document.getElementById("result2").innerHTML = `You: ${user2} <br />Invalid Input<br /><br />`;
  }
}
...
const API_KEY = "af1bfc25c33f12a45b6c25b1532d835b";
...
function createPost(url, index) {

    const post = document.createElement("div");

    post.className = "image-box";

    post.innerHTML = `

<div class="profile">

<img src="https://i.ibb.co/jnyNYQ0/one.png">

<label>Uploaded on OCTRIN</label>
...
<button class="imgLike">&#9825 Like</button>

<button class="imgComment">💬 Comment</button>

<button class="imgShare">🔗 Share</button>
...
`;
    ...
    uploadedImages.appendChild(post);

    // Like

    post.querySelector(".imgLike").addEventListener("click", function () {
    ...
    post.querySelector(".deletePost").addEventListener("click", () => {
